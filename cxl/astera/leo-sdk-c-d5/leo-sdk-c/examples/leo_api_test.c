...
int main(int argc, char *argv[]) {
  ...
  if (defaultArgs.bdf != NULL) {
    ...
    if (rc != LEO_SUCCESS) {
      ...
      ASTERA_ERROR("If Leo ASIC used is A0 revision, use A0 version of SDK");
      return rc;
    }
...
#if defined CHIP_D5
  if (leoDevice->asicVersion.minor == LEO_ASIC_A0) {
    ASTERA_ERROR("ASIC Version is A0 and SDK version is D5, please use Leo-A0 version of SDK");
    asteraI2CCloseConnection(leoHandle);
    return rc;
  }
#endif
